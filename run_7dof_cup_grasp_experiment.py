...
from utils.robot_7dof_grasp_utils.train_teleop_model import train_telop_controller_with_quantiles, train_ensemble_teleop_controller
...
if __name__ == '__main__':
    ...
    if calibration_type == 'acqr':
        from utils.robot_7dof_grasp_utils.calibrate_teleop_model import calibrate_teleop_model_with_acqr as calibrate_teleop_model
    elif calibration_type == 'qr':
        from utils.robot_7dof_grasp_utils.calibrate_teleop_model import calibrate_teleop_model_with_qr as calibrate_teleop_model
    elif calibration_type == 'ensemble':
        from utils.robot_7dof_grasp_utils.calibrate_teleop_model import calibrate_teleop_model_with_ensemble as calibrate_teleop_model
    else:
