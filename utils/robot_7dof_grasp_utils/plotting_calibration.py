...
def plot_calibration_results(calibration_traj_idx_to_data,
    ...
    for traj_index in calibration_traj_idx_to_data:
        ...
        calibration_traj_data = calibration_traj_idx_to_data[traj_index]

        uncertainty_list = individual_trial_results[traj_index]['uncertainty_list']
        dimension_to_bounds = individual_trial_results[traj_index]['dimension_to_bounds']
        list_of_errors_over_time = individual_trial_results[traj_index]['list_of_errors_over_time']
        list_of_alphas_over_time = individual_trial_results[traj_index]['list_of_alphas_over_time']
        list_of_factor_lambda_over_time = individual_trial_results[traj_index]['list_of_factor_lambda_over_time']
