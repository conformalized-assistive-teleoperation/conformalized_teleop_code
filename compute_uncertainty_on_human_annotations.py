...
if __name__ == '__main__':
    ...
    if calibration_type == 'acqr':
        from utils.robot_7dof_goal_utils.calibrate_teleop_model import calibrate_teleop_model_with_acqr_w_human_data as calibrate_teleop_model
        ...
        from utils.robot_7dof_goal_utils.calibrate_teleop_model import calibrate_teleop_model_with_qr_w_human_data as calibrate_teleop_model
    else:
    ...
    # for human_annot in ['h1']:
        for task_color in ['red']:
            ...
            calibrate_teleop_model(human_data,
                                   teleop_model_filepath,
                                   teleop_model_architecture,
                                   config,
                                   experiment_name, human_annot, task_color, to_plot=True)
